#ifndef CONDITIONVARIABLESSERVER_INKAALICJA_CALLNR_H
#define CONDITIONVARIABLESSERVER_INKAALICJA_CALLNR_H
...
#endif //CONDITIONVARIABLESSERVER_INKAALICJA_CALLNR_H
